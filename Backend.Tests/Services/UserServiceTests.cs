    ...
    public class UserServiceTests : BaseTest
    {
        ...
        protected override void ConfigureServices(IServiceCollection services)
        {
            ...
            _userManagerMock
                ...
                {
                    return new List<string> { Role.Tutor.ToString(), Role.Student.ToString() };
                });
            _userManagerMock
        ...
        public async Task RegisterUser_ShouldRegisterUser_WhenEmailDoesNotExist()
        {
            ...
            // Act
            var (result, error) = await _userService.RegisterUser(model, "AU");
        ...
        {
            // Act
            var result = await _userService.GetUser("999");
