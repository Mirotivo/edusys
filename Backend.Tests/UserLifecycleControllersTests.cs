...
namespace Backend.Tests
{
    public class UserLifecycleControllersTests : BaseTest
    {
        ...
        public UserLifecycleControllersTests(WebApplicationFactory<Program> factory) : base(factory)
        {
            ...
            _paymentController = new PaymentsAPIController(paymentService);
        ...
        protected override void ConfigureServices(IServiceCollection services)
        {
            ...
            _mockStripePaymentGateway
                .Setup(gateway => gateway.CreatePayment(It.IsAny<decimal>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>()))
            ...
            _mockStripePaymentGateway
                .Setup(gateway => gateway.ProcessPayment(It.IsAny<string>(), It.IsAny<decimal>(), It.IsAny<string>()))
        ...
        private async Task<int> GetLessonByStudenttId(string studentId)
        {
            var getLessonsResponse = await _lessonController.GetLessonsAsync(studentId);
